...
public class BuildingDTO {
	...
	public BuildingDTO(int building_id, int land_size, int build_area_size, int quantity_bedrooms,
			int quantity_bathrooms, int quantity_garage) {
		super();
		this.building_id = building_id;
		this.land_size = land_size;
		this.build_area_size = build_area_size;
	...
	public String toString() {
		return "BuildingDTO [building_id=" + building_id + ", land_size=" + land_size + ", build_area_size="
				+ build_area_size + ", quantity_bedrooms=" + quantity_bedrooms + ", quantity_bathrooms="
				+ quantity_bathrooms + ", quantity_garage=" + quantity_garage + "]";
	}
